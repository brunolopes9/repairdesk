...
public sealed record HardDeleteClienteResponse(Guid ClienteId, string Nome, DateTime DeletedAt, int Reparacoes, int Trabalhos, int Despesas, int Fotos, int Vendas);
