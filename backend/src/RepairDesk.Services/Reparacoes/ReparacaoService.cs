...
public class ReparacaoService : IReparacaoService
{
        ...
        bool precisaConfirmacaoGarantia = false)
    {
        ...
        var cliente = r.Cliente is not null
            ? new ClienteResumo(r.Cliente.Id, r.Cliente.Nome, r.Cliente.Telefone ?? string.Empty, r.Cliente.Nif, r.Cliente.Email, r.Cliente.NotaImportante, r.Cliente.NaoContactar, r.Cliente.ContactoPreferido)
