...
export default function CommandPalette() {
  ...
  const commands: Command[] = useMemo(
    () => [
      ...
      { id: 'nav-clientes', label: 'Clientes', icon: Users, keywords: ['clientes', 'contactos', 'crm'], action: () => navigate('/clientes') },
      { id: 'nav-campanhas', label: 'Campanhas CRM', icon: Megaphone, keywords: ['campanhas', 'outreach', 'marketing', 'etiquetas', 'tags', 'segmentos'], action: () => navigate('/clientes/campanhas') },
      { id: 'nav-reparacoes', label: 'Reparações', icon: Wrench, keywords: ['reparacoes', 'reparações', 'tickets'], action: () => navigate('/reparacoes') },
      { id: 'nav-agendamentos', label: 'Agendamentos', icon: CalendarClock, keywords: ['agendamentos', 'bookings', 'calendario', 'marcacoes'], action: () => navigate('/agendamentos') },
      { id: 'nav-tarefas', label: 'Tarefas', icon: ClipboardCheck, keywords: ['tarefas', 'todo', 'checklist', 'pendentes'], action: () => navigate('/tarefas') },
      { id: 'nav-trabalhos', label: 'Trabalhos', icon: Briefcase, keywords: ['trabalhos', 'jobs', 'projectos'], action: () => navigate('/trabalhos') },
      { id: 'nav-balcao', label: 'Balcão', icon: ShoppingCart, keywords: ['balcao', 'balcão', 'pos', 'vendas', 'caixa', 'carrinho'], action: () => navigate('/balcao') },
      { id: 'nav-caixa', label: 'Caixa de hoje', icon: Banknote, keywords: ['caixa', 'dinheiro', 'fecho', 'z-report', 'z reports'], action: () => navigate('/balcao?tab=caixa') },
      { id: 'nav-compras-operacao', label: 'Compras e Operação', icon: Receipt, keywords: ['compras', 'operacao', 'operação', 'financeiro', 'faturas', 'facturas', 'custos'], action: () => navigate('/compras-operacao') },
      { id: 'nav-documentos', label: 'Vendas · Faturas', icon: FileText, keywords: ['documentos', 'faturas', 'facturas', 'vendas', 'moloni'], action: () => navigate('/documentos') },
      { id: 'nav-compras', label: 'Compras · Fornecedores', icon: Receipt, keywords: ['compras', 'fornecedores', 'fornecedor', 'pecas', 'peças', 'material', 'stock', 'supplier invoices'], action: () => navigate('/compras') },
      { id: 'nav-despesas', label: 'Despesas & custos', icon: Banknote, keywords: ['despesas', 'custos', 'opex', 'renda', 'software', 'combustivel', 'combustível', 'comunicacoes', 'comunicações', 'seguros'], action: () => navigate('/despesas') },
      { id: 'nav-catalogo', label: 'Catálogo & Stock', icon: Boxes, keywords: ['catalogo', 'catálogo', 'stock', 'produtos', 'inventario', 'inventário'], action: () => navigate('/catalogo') },
      { id: 'nav-stock', label: 'Stock (peças)', icon: PackageSearch, keywords: ['stock', 'inventario', 'inventário', 'peças', 'pecas', 'fisico', 'físico', 'prateleira'], action: () => navigate('/stock') },
      { id: 'nav-produtos', label: 'Produtos (retail)', icon: Package, keywords: ['produtos', 'retail', 'loja online', 'dropshipping', 'montra', 'telemoveis', 'telemóveis'], action: () => navigate('/produtos') },
      { id: 'nav-inventario', label: 'Contagens físicas', icon: ClipboardCheck, keywords: ['contagens', 'inventario', 'inventário', 'stocktake', 'auditoria stock'], action: () => navigate('/inventario') },
      { id: 'nav-precos', label: 'Tabela de preços', icon: Tags, keywords: ['precos', 'preços', 'tabela', 'pricing'], action: () => navigate('/precos') },
