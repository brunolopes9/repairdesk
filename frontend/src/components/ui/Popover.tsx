  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {open && (
        <div
          role="tooltip"
          className="absolute left-0 right-0 top-full z-10 mt-2 rounded-lg border border-brand-200 bg-white p-3 text-sm shadow-lg dark:border-brand-900 dark:bg-zinc-900 sm:left-1/2 sm:right-auto sm:w-72 sm:-translate-x-1/2"
        >
