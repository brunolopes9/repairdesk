...
export default function Webhooks() {
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        title="Webhooks"
        description="Recebe eventos do RepairDesk no teu servidor (loja online, automações). Cada delivery é assinada com HMAC-SHA256 para verificares autenticidade."
          ...
          <div className="rounded-md bg-amber-50 p-3 text-xs text-amber-900 dark:bg-amber-950/40 dark:text-amber-200">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                Usa-o para verificar HMAC-SHA256 do payload no header <code className="font-mono">X-RepairDesk-Signature</code>.
              </div>
            </div>
          </div>
