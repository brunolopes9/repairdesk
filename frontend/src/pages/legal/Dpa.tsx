  ...
  return (
    <LegalLayout title="Contrato de Processamento de Dados (DPA)" lastUpdated="22 Maio 2026">
      <p>
        ...
        RepairDesk entre o Cliente (Responsável pelo Tratamento) e a LopesTech (Subcontratante),
        nos termos do Regulamento (UE) 2016/679 (RGPD).
      </p>

      <Section title="1. Definições">
        <ul className="list-disc pl-6">
          <li><strong>Cliente / Tenant</strong>: a entidade que utiliza o RepairDesk.</li>
          <li><strong>LopesTech</strong>: Bruno Lopes, sediada em Viseu, Portugal, fornecedor do RepairDesk.</li>
          <li><strong>Dados Pessoais</strong>: qualquer informação relativa a pessoa singular identificada
          ou identificável processada no contexto do RepairDesk.</li>
      ...
      <Section title="2. Objecto e duração">
        <p>
          ...
          fornecer as funcionalidades do RepairDesk. O tratamento dura enquanto a conta estiver activa
