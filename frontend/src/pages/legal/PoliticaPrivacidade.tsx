  ...
  return (
    <LegalLayout title="Política de Privacidade" lastUpdated="2026-05-17">
      <p>
        ...
        tratamos quando visitas o nosso site, nos contactas ou usas o RepairDesk enquanto
        utilizador de uma loja.
      </p>
      <p>
        O RepairDesk é um software de gestão para oficinas de reparação. Quando uma loja
        usa o RepairDesk para gerir os seus próprios clientes, <strong>a loja é a responsável
      ...
      <Section title="1. Quem somos">
        <p>O RepairDesk é desenvolvido pela LopesTech, projecto de Bruno Lopes, em Portugal.</p>
        <p>
      ...
      <Section title="2. Que dados recolhemos">
        ...
        <h3 className="mt-4 font-medium text-zinc-900 dark:text-zinc-100">Utilizadores do RepairDesk</h3>
        <ul className="ml-5 list-disc space-y-1">
          <li>nome, email</li>
        ...
        <h3 className="mt-4 font-medium text-zinc-900 dark:text-zinc-100">Dados que as lojas colocam no RepairDesk</h3>
        <p>
        ...
        <div className="overflow-x-auto rounded-lg border border-zinc-200 dark:border-zinc-800">
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800">
              <tr><td className="px-3 py-2">Prestar o RepairDesk (conta, login, loja, operação)</td><td className="px-3 py-2">Execução de contrato</td></tr>
      ...
      <Section title="4. Com quem partilhamos dados">
        <p>Podemos usar fornecedores técnicos para operar o RepairDesk, por exemplo:</p>
        <ul className="ml-5 list-disc space-y-1">
      ...
      <Section title="6. Durante quanto tempo guardamos os dados">
        <ul className="ml-5 list-disc space-y-1">
          <li>conta RepairDesk: durante a vigência da conta</li>
      ...
      <Section title="7. Direitos dos titulares">
        ...
        <p>
          Para exercer direitos sobre a tua conta RepairDesk ou contacto com a LopesTech, escreve
        ...
        <p>
          Se fores cliente final de uma loja que usa RepairDesk, contacta primeiro essa loja —
