...
export default function Termos() {
  return (
    <LegalLayout title="Termos de Serviço" lastUpdated="2026-05-17">
      <p>
        Estes Termos regulam a utilização do RepairDesk, um software SaaS de gestão para
        oficinas de reparação. Ao criar conta ou usar o RepairDesk, a loja aceita estes Termos.
      </p>

      <Section title="1. Quem presta o serviço">
        <p>O RepairDesk é prestado pela LopesTech, projecto de Bruno Lopes, em Portugal.</p>
        <p>
      ...
      <Section title="2. Quem pode usar">
        <p>
          O RepairDesk destina-se a profissionais, empresas e trabalhadores independentes
          que gerem reparações, clientes, equipamentos, orçamentos, despesas e operação de
          oficina.
        </p>
        <p>
          Ao usar o RepairDesk em nome de uma loja ou empresa, declaras que tens autorização
          para aceitar estes Termos em nome dessa entidade.
        </p>
      </Section>

      <Section title="3. O que o RepairDesk faz">
        <p>O RepairDesk ajuda a gerir:</p>
        ...
        <p>
          Salvo indicação expressa em contrário, o RepairDesk não substitui aconselhamento
      ...
      <Section title="4. Documentos fiscais e facturação">
        <p>
          Enquanto o RepairDesk não tiver módulo fiscal certificado ou integração certificada
      ...
      <Section title="6. Propriedade dos dados">
        <p>
          Os dados inseridos pela loja no RepairDesk <strong>pertencem sempre à loja</strong> ou aos
        ...
        <p>
          ...
          objectivo do RepairDesk é evitar lock-in.
        </p>
      </Section>
      ...
      <Section title="9. Disponibilidade e SLA">
        <p>A LopesTech fará esforços razoáveis para manter o RepairDesk disponível e seguro.</p>
      ...
      <Section title="11. Uso aceitável">
        <p>Não é permitido usar o RepairDesk para:</p>
        <ul className="ml-5 list-disc space-y-1">
      ...
      <Section title="12. Limitação de responsabilidade">
        <p>
          ...
          indevido do RepairDesk pela loja.
        </p>
        <p>
